...
NOTE: The Quickstart requires Java 8 and a recent Git (2.20 or newer preferred) to be available on your machine. If you miss any of those go through the steps described in <<prerequisites>>.
...
https://adoptopenjdk.net/?variant=openjdk8[Download] the binaries, install. Make sure the console shows something like this:
