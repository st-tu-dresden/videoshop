...
[small]_Note: Such a complex use case does definitely need to be shown in detail with a sequence diagram. We opted out of showing more diagrams to reduce the size of this document._
